Hostsharing-Ansible-Mosparo
===========================

This Ansible playbook will prepare a [Mosparo](https://mosparo.io) on a server from www.hostsharing.net.
...
We clone this git-repo to our machine:
    ...
    $ git clone https://github.com/tpokorra/Hostsharing-Ansible-Mosparo.git

Then we change the working directory:

    $ cd Hostsharing-Ansible-Mosparo
